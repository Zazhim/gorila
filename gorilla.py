...
def callback_inline(call):
    try:
        if call.data == "qweth":
            ...
            bot.send_message(chat_id = call.from_user.id, text = """<a href="https://imbt.ga/2sicF42UNY">.</a>\nМинимум — Максимум\n<b>100$ — 5000$</b>\n\n\nКомиссия за заказ 50% с любой суммой заказа от\n<b>100$ — 5000$</b>""",reply_markup =KeyBack, parse_mode='HTML')
            #bot.send_photo(chat_id = call.from_user.id, photo = 'https://imbt.ga/2sicF42UNY',reply_markup=KeyBack)

        elif call.data == "teaching":
            bot.send_message(chat_id = call.from_user.id, text = """Сервис <a href="https://t.me/joinchat/AAAAAESUWKdBc_aHDTDGBw">GORILLA_VBIV||ASOS||AMAZON||FARFETCH</a>\nпроводит личное обучение кардингу🚧\n\n\n• Хочешь иметь топовый шмот, но не имеешь денег? 👔\n• Хочешь получать солидный доход легким путём? 💵\n• Хочешь иметь лучшую технику, но хватает только на Xiaomi? 👎🏼\n\n\nКто-то может подумать, что кардинг, это только про шмотки и одежду – это не так! Кроме Гуччи, баленсиага, трэшеров и остального брендового говна, вы можете кардить и электронику: телефоны, планшеты, ноутбуки, бытовую технику, пауэрбэнки, умные колонки, наушники и кучу всего остального. Включайте фантазию\nВсего один пак из наушников для сони плейстейшн на 2000$ - можно продать за 1500$ в России моментально!\n\n<b>Что входит в курс личного обучения вбива?💳</b>\n\n• Все нюансы безопасности и анонимности 🔒\n• Настроим твоё устройство для работы 📱\n• Сделаем первый вбив под личным патронажем 👥\n• Работа со скупами/посредами.\n• Рероут/Пикап.\n• Правильный выбор материала для работы.\nВбивы до 500$ на посреда.\nДо 3к$ на скупа/пересыл в RU\n\n<b>+ Бонусы:</b>\nЧат. Вас ждет охуенная компания в нашем уютном чате соратников, которые всегда вас поддержат. \nКуча дополнительных материалов по кардингу и анонимности. \nВозможность быстрой продажи вашего товара на "GORILLA VBIV\n<b>Сколько длиться курс?</b>\nРабота с вами продолжается до тех пор, пока вы самостоятельно не сделаете заказ. 🌲\n\n\n<b>Что нужно иметь?</b>\nВам нужно иметь только компьютер с интернетом, голову на плечах, сумму в 10к рублей + 500-1000 рублей на расходники.\nКоличество мест: 10\nКому писать, знаете сами.\nTelegram: @gorilla_vbiv 📲\nВсегда на связи\n\n\n<b>Цена фиксированная:20к₽</b>""", parse_mode='HTML')
